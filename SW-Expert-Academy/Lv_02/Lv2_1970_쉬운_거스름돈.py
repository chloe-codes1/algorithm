...
for t in range(1, T+1):
    ...
    count_50000 = int(change/50000)
    change = change % 50000
    
    count_10000 = int(change/10000)
    change = change % 10000
    
    count_5000 = int(change/5000)
    change = change % 5000
    
    count_1000 = int(change/1000)
    change = change % 1000
    ...
    print(count_50000, count_10000, count_5000, count_1000, count_500, count_100 ,count_50, count_10)